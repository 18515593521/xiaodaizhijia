window.TILE_VERSION = {
    "ditu": {
        "normal": {"version": "088", "updateDate": "20180303"},
        "satellite": {"version": "009", "updateDate": "20180303"},
        "normalTraffic": {"version": "081", "updateDate": "20180303"},
        "satelliteTraffic": {"version": "083", "updateDate": "20180303"},
        "mapJS": {"version": "104", "updateDate": "20180303"},
        "satelliteStreet": {"version": "083", "updateDate": "20180303"},
        "panoClick": {"version": "1033", "updateDate": "20180302"},
        "panoUdt": {"version": "20180302", "updateDate": "20180302"},
        "panoSwfAPI": {"version": "20150123", "updateDate": "20150123"},
        "panoSwfPlace": {"version": "20141112", "updateDate": "20141112"},
        "earthVector": {"version": "001", "updateDate": "20180303"}
    },
    "webapp": {
        "high_normal": {"version": "001", "updateDate": "20180303"},
        "lower_normal": {"version": "002", "updateDate": "20180303"}
    },
    "api_for_mobile": {
        "vector": {"version": "002", "updateDate": "20180303"},
        "vectorIcon": {"version": "002", "updateDate": "20180303"}
    }
};
...
(function () {
    ...
    function addRoute(map, points, type, coordType) {
        var config = [{stroke: 6, color: "#0030ff", opacity: 0.45, style: "solid"}, {
            stroke: 6,
            color: "#0030ff",
            opacity: 0.45,
            style: "solid"
        }, {stroke: 4, color: "#30a208", opacity: 0.55, style: "dashed"}, {
            stroke: 5,
            color: "#0030ff",
            opacity: 0.45,
            style: "solid"
    ...
    function BaseSearch(loc, opts) {
        ...
        this._opts = {
            coordType: BMAP_COORD_LNGLAT,
            renderOptions: {panel: null, map: null, autoViewport: true},
    ...
    baidu.extend(LocalSearch.prototype, {
        search: function (keyword) {
            ...
            var r = this._json.result, c = this._json.content, cc = this._json.current_city, type = r.type, me = this,
                pageNum = r.page_num || 0, total = 0, count = 0, results = [], points = [], cityList = [], count, total;
        ...
        setPolicy: function (policy) {
            ...
            if (this._opts.renderOptions.panel && this._opts.renderOptions.panel.appendChild && this._results && this._results.getNumPlans() > 0) {
                ...
                for (var i = 0, l = this._results.getNumPlans(); i < l; i++) {
                    var plan = this._results.getPlan(i), dis = plan.getDistance().replace(/(\d+(?:.\d+)?)/, "$1 "),
                        dur = plan.getDuration().replace(/(\d+)/, "$1 "), bg = "";
                    if (this._curIndex == i) {
    ...
    baidu.extend(Geolocation.prototype, {
        getCurrentPosition: function (callback, opts) {
            ...
            var coord = position.coords, me = this,
                reqParams = {x: coord.longitude, y: coord.latitude, from: "0", to: "4"};
            DataMgr.request(function (json) {
    ...
    baidu.extend(Geocoder.prototype, {
        getPoint: function (address, callback, city) {
            ...
            var me = this,
                ...
                x = point.lng, y = point.lat, opts = opts || {}, poiRadius = opts.poiRadius || 100,
